...
const portfoliosData = [
  {
    ...
    description:
      'A full-featured e-commerce solution with real-time inventory, secure payments (Stripe), and a high-performance dashboard for admins.',
    image:
  ...
  },
  {
    ...
    description:
      'Intelligent business analytics platform that uses machine learning to provide predictive insights and automated reporting for SaaS companies.',
    image:
      'https://images.unsplash.com/photo-1551288049-bbdac8626ad1?q=80&w=2000&auto=format&fit=crop',
  ...
  },
  {
    ...
    description:
      'Track and analyze your investments in real-time. Supports stocks, crypto, and traditional assets with deep historical analysis and performance metrics.',
    image:
      'https://images.unsplash.com/photo-1611974714851-129083375a02?q=80&w=2000&auto=format&fit=crop',
  ...
  },
  {
    ...
    description:
      'Immersive property search experience with 3D tours, interactive maps, and automated communication between buyers and agents.',
    image:
